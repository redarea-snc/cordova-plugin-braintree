...
BraintreePlugin.paypalProcess = function paypalProcess(amount, currency, itemDesc, successCallback, failureCallback) {
  exec(successCallback, failureCallback, PLUGIN_ID, 'paypalProcess', [amount, currency, itemDesc]);
};
